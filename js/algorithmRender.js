...
function renderAlgorithm(linkId, htmlPath, pyPath, codeId, projectId, projectUrl) {
    ...
    link.addEventListener("click", (event) => {
        event.preventDefault();
        //document.getElementsById('mn3').scrollIntoView({ behavior: 'smooth', block: 'start', inline: 'start' });
        fetch(htmlPath)
...
// Usage
renderAlgorithm("001", "./algorithms/linearRegression.html", "./python_guides/linearRegression.py", "linearRegression-code", "project-linearRegression", "https://www.google.com");
renderAlgorithm("007", "./algorithms/dtr.html", "./python_guides/decisionTreeRegression.py", "dtr-code", "project-dtr", "https://www.amazon.com");
