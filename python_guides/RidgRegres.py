# CODE IMPLEMENTATION: Ridge Regression
...
from sklearn.linear_model import Ridge, RidgeCV # Ridge Regression
...
# RIDGE REGRESSION WORKS WITH NUMERICAL DATA
...
model = Ridge(alpha=10) # Manual selection of alpha value (Use of RidgeCV recommended for finding optimal alpha value)
